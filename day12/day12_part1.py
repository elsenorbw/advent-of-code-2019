...
the_universe.display_moons()
for this_step in range(10):
    the_universe.step()
# should be 179, and it is 
...
for this_step in range(1000):
    puzzle_universe.step(False)
puzzle_universe.display_moons()
